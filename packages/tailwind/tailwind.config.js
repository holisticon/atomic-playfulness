...
export const theme = {
  extend: {
    ...
    shadow: {
      firstLevel: {
        color: "var(--hap-shadow-first-level-color)",
        x: "var(--hap-shadow-first-level-x)",
        y: "var(--hap-shadow-first-level-y)",
        blur: "var(--hap-shadow-first-level-blur)",
      },
      secondLevel: {
        color: "var(--hap-shadow-second-level-color)",
        x: "var(--hap-shadow-second-level-x)",
        y: "var(--hap-shadow-second-level-y)",
        blur: "var(--hap-shadow-second-level-blur)",
      },
    },
  },
};
